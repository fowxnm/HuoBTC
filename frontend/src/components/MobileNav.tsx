...
const MobileNav: Component = () => {
  ...
  return (
    <nav class="fixed bottom-0 left-0 right-0 z-50 bg-[#0f0f16]/95 backdrop-blur-md border-t border-[#2c2c3e] md:hidden pb-safe flex justify-around items-center h-[60px] shadow-lg">
