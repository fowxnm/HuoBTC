...
console.log(`
╔════════════════════════════════════════════════════════════╗
║          BTC Exchange Backend v2.0.0 (Monorepo)            ║
╠════════════════════════════════════════════════════════════╣
...
╠════════════════════════════════════════════════════════════╣
║  Eden Treaty:       Type-safe client available             ║
║  Shared Package:    @btc/shared (Money precision)          ║
╚════════════════════════════════════════════════════════════╝
`);

// Export App type for Eden Treaty client generation
